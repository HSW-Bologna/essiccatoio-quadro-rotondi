...
#define I2C_WP_LAT LATCbits.LATC2
...
#define WRITE_PROTECT I2C_WP_LAT
#define WRITE_PROTECT_TRIS I2C_WP_TRIS

#define UART1_RX_TRIS TRISCbits.TRISC9
#define UART1_TX_TRIS TRISCbits.TRISC8
#define UART2_RX_TRIS TRISCbits.TRISC7
#define UART2_TX_TRIS TRISBbits.TRISB9 
#define UART2_DIR_TRIS TRISCbits.TRISC6
#define UART2_DIR_LAT LATCbits.LATC6
