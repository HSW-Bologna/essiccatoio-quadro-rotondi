...
${OBJECTDIR}/main/peripherals/uart_driver.o: main/peripherals/uart_driver.c  .generated_files/flags/default/1019d86c083d5c1cca93adb04b058fdae8e5af53 .generated_files/flags/default/2db072753653b0b8fce8a71379649f41a47989a8
	@${MKDIR} "${OBJECTDIR}/main/peripherals" 
...
${OBJECTDIR}/main/peripherals/uart_driver.o: main/peripherals/uart_driver.c  .generated_files/flags/default/341bf23abaa4c5c282dcc7832bb515c4dd6ff1c .generated_files/flags/default/2db072753653b0b8fce8a71379649f41a47989a8
	@${MKDIR} "${OBJECTDIR}/main/peripherals" 
	@${RM} ${OBJECTDIR}/main/peripherals/uart_driver.o.d 
	@${RM} ${OBJECTDIR}/main/peripherals/uart_driver.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  main/peripherals/uart_driver.c  -o ${OBJECTDIR}/main/peripherals/uart_driver.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/main/peripherals/uart_driver.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -I"components/gel" -I"main" -I"components/I2C" -I"main/peripherals" -I"main/controller" -I"main/config" -I"components/liblightmodbus/include" -I"components/SPI" -DGEL_IGNORE_TIME_TYPECHECK -msmart-io=1 -Wall -msfr-warn=off   -std=c99  -mdfp="${DFP_DIR}/xc16"
